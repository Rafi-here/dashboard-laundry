   ...
   <?php if (order_dc($_POST) > 0) :?>
      ...
      <div class="box">
         <img src="<?=url('_assets/img/berhasil.png')?>" height="68" alt="alert sukses">
            ...
            <button onclick="window.location='http://localhost/crud_laundry/'" class="btn-alert">Ok</button>
         </div>
      </div>
   <?php else : ?>
      <div class="alert">
         <div class="box">
            ...
            <button onclick="window.location='http://localhost/cruds_laundry/'" class="btn-alert">Ok</button>
         </div>
      </div>
   <?php endif ?>
<?php endif ?>
